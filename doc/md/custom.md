...
- [ ] upload `debian-live-config-X.Y.Z-debian-bookworm-amd64.iso` to `files.awesome-selfhosted.net`

```bash
rsync -avP iso/debian-live-config-X.Y.Z-debian-bookworm-amd64.iso a161f1.online-server.cloud:
ssh -t a161f1.online-server.cloud sudo mv debian-live-config-X.Y.Z-debian-bookworm-amd64.iso /var/www/files/
ssh -t a161f1.online-server.cloud sudo chmod 0644 /var/www/files/debian-live-config-X.Y.Z-debian-bookworm-amd64.iso
```
