...
**[![](download.png) Download](https://files.awesome-selfhosted.net/debian-live-config-5.0.0-debian-bookworm-amd64.iso)** the latest ISO image
...
wget https://files.awesome-selfhosted.net/debian-live-config-5.0.0-debian-bookworm-amd64.iso
